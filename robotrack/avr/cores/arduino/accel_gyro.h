...
inline float get_last_x_angle(void);
inline float get_last_y_angle(void);
inline float get_last_z_angle(void);

inline float get_last_gyro_x_angle(void);
inline float get_last_gyro_y_angle(void);
inline float get_last_gyro_z_angle(void);
